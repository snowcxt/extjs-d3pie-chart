...
Ext.define('Sandbox.ux.chart.series.D3Pie', (function () {
    return {
        ...
        drawSeries: function () {
            ...
            self.donut = Math.ceil(
                (self.donut !== undefined) ? Math.min(self.radius - 1, self.donut) : (self.radius - 10)
            );

            chartEl = d3.select('#' + self.chart.getId() + ' svg')
                .attr('width', chart.width)
                .attr('height', chart.height);

            minSide = Math.min(chart.width, chart.height);
            centerX = (self.centerX || (minSide / 2));
            centerY = (self.centerY || (minSide / 2));
            centerTranslate = ('translate(' + centerX + ',' + centerY + ')');
        ...
        updateChart: function () {
            var self = this,
                ...
                getTextAnchorForLabel = function (d) {
                ...
                filteredStoreData = donutFn(storeData)
        ...
        highlightItem: function () {
            ...
            self.d3ApplyStyleToItems(self.highlightStyle, self.index);
        },
        ...
        unHighlightItem: function () {
            ...
            self.d3ApplyStyleToItems(self.unHighlightStyle, self.index);
        },
